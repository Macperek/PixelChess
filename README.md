...
A homebrew pixel-art chess game developed specifically for the PlayStation Vita. 
**Please note that this is an amateur project created for fun and learning.**
...
1. Download the latest `PixelChess.vpk` from the [Releases](link_do_zakladki_releases) page.
...
To compile this project, you need the [VITASDK](https://vitasdk.org/) installed and configured.
